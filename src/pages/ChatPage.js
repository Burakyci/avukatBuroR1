...
export default function chatPage() {
  return (
    ...
    >
      <MDBRow>
        <MDBCol md="6" lg="5" xl="4" className="mb-4 mb-md-0 bg-dark">
          ...
          <MDBCard className="bg-dark">
            <MDBCardBody className="bg-dark">
              <MDBTypography listUnStyled className="mb-0">
                <li
                  className="p-2 border-bottom bg-dark"
                  style={{ backgroundColor: "#eee" }}
                >
        ...
        <MDBCol md="6" lg="7" xl="8">
          <MDBTypography listUnStyled>
            ...
            <li class="d-flex justify-content-between mb-4 bg-dark">
              <MDBCard className="w-100 bg-dark">
                <MDBCardHeader className="d-flex justify-content-between p-3">
            ...
            <li className="d-flex justify-content-between mb-4 bg-dark">
              <img
                src="https://mdbcdn.b-cdn.net/img/Photos/Avatars/avatar-6.webp"
                alt="avatar"
                className="rounded-circle d-flex align-self-start me-3 shadow-1-strong"
              ...
              />
              <MDBCard>
                <MDBCardHeader className="d-flex justify-content-between bg-dark p-3">
                  <p className="fw-bold mb-0">Brad Pitt</p>
                  <p className="text-muted small mb-0">
